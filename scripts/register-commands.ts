        ...
        options: [
          {
            ...
            required: false,
            choices: [
              { name: 'Red Dyes', value: 'red' },
              { name: 'Brown Dyes', value: 'brown' },
              { name: 'Yellow Dyes', value: 'yellow' },
              { name: 'Green Dyes', value: 'green' },
              { name: 'Blue Dyes', value: 'blue' },
              { name: 'Purple Dyes', value: 'purple' },
              { name: 'White/Black Dyes', value: 'white-black' },
            ],
          },
        ],
      },
